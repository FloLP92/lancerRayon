...
// Copyright   :
// Description : Classe impl�mentant des methodes statiques de calcul utilises par les autres classes (header)
//============================================================================*/
...
public:
	...
	static Coord3 calculRayonReflechi(Coord3 origine,Coord3 ptSurface,Coord3 centreSphere);
	static std::valarray<float> calculVecteurUnitaire(std::valarray<float> vecteur);
	...
	static RGB calculCouleur2(float cos,RGB couleurRayon,RGB couleurSource,RGB couleurInter,float coefReflexion);
